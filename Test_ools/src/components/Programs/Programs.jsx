...
import './Programs.css'
import program_1 from '../../assets/out.jpg'
    ...
    <div className='programs'>
        <div className="program">
            ...
            <div className="caption">
                ...
                <h1>OUTING</h1>
                <p>Apply Outing</p>
                <button className='btn' onClick={() => {setFormState(true)}}>Apply <img src={arrow} alt="" className='imgr'/></button>
            </div>
        </div>
        <div className="program">
            <img src={program_2} alt=''/>
            <div className="caption">
                ...
                <h1>LEAVE</h1>
                <p>Apply Leave</p>
                <button className='btn'>Apply <img src={arrow} alt="" className='imgr'/></button>
            </div>
        </div>
        <div className="program">
